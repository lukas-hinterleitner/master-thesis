...
# store dot products
with open(get_dot_product_bm25_selected_file_path("dot_products"), "w") as output_file:
    json.dump(dot_products, output_file, indent=4)

with open(get_dot_product_bm25_selected_file_path("paraphrased_dot_products"), "w") as output_file:
    json.dump(paraphrased_dot_products, output_file, indent=4)

with open(get_dot_product_bm25_selected_file_path("original_dot_products"), "w") as output_file:
