...
from utilities.computation import calculate_paraphrased_layer_dot_products
from utilities.storage import get_dot_product_paraphrased_file_path
...
dot_products, paraphrased_dot_products, original_dot_products = calculate_paraphrased_layer_dot_products(original_dataset_tokenized, paraphrased_dataset_tokenized, model)
