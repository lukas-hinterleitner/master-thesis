...
python src/combine_results.py --result-type paraphrased-gradient-projection

# Combine paraphrased dot product results
echo "Combining paraphrased dot product results..."
python src/combine_results.py --result-type paraphrased-dot-product

# Combine model-generated gradient similarity results
echo "Combining model-generated gradient similarity results..."
python src/combine_results.py --result-type model-generated-gradient
...
python src/combine_results.py --result-type model-generated-gradient-projection

# Combine model-generated dot product results
echo "Combining model-generated dot product results..."
python src/combine_results.py --result-type model-generated-dot-product
