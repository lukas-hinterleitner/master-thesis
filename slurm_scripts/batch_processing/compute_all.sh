...
python slurm_scripts/batch_processing/batch_processing.py --setting paraphrased --computation-type gradient-similarity --num-partitions $NUM_PARTITIONS
...
python slurm_scripts/batch_processing/batch_processing.py --setting paraphrased --computation-type gradient-similarity --use-random-projection --num-partitions $NUM_PARTITIONS

# Generate and submit jobs for paraphrased dot product
echo "Generating paraphrased dot product jobs..."
python slurm_scripts/batch_processing/batch_processing.py --setting paraphrased --computation-type dot-product --num-partitions $NUM_PARTITIONS

# Generate and submit jobs for model-generated gradient similarity
echo "Generating model-generated gradient similarity jobs..."
python slurm_scripts/batch_processing/batch_processing.py --setting model-generated --computation-type gradient-similarity --num-partitions $NUM_PARTITIONS
...
python slurm_scripts/batch_processing/batch_processing.py --setting model-generated --computation-type gradient-similarity --use-random-projection --num-partitions $NUM_PARTITIONS
